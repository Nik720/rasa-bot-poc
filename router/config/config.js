...
config.WHATSAPP_AUTHORIZATION      = env.WHATSAPP_AUTH_TOKEN || 'token'
config.WHATSAPP_MESSAGE_TYPE       = 'text'
config.WHATSAPP_SOURCE             = env.WHATSAPP_SOURCE || '461089f9-1000-4211-b182-c7f0291f3d45'
...
config.CONFIG_BLOB_PATH = env.CONFIG_BLOB_PATH || 'sunbirddev'
